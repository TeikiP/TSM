...
{	char 		*progname, *infilename;
  ...
  SF_INFO	 	sfinfo ;
	...
	while (read_samples (infile, new_buffer, sfinfo.channels)==1)
      ...
      int freq = (double)maxIndex*sfinfo.samplerate/FRAME_SIZE;
      int pitch = 57.0 + 12.0 * log2(freq/440.0);
	    ...
	    printf("Processing frame %3d (max freq = %d, pitch of %d)\n", nb_frames, freq, pitch);
